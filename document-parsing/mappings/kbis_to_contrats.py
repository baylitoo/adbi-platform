...
def _normalize_date(raw: Any, field_key: str, warnings: list[str]) -> str:
    ...
    ISO transparent, DD/MM/YYYY converti, date ecrite en toutes lettres lue
    via la table de mois partagee, sinon vide + avertissement).
    ...
    if _ISO_DATE_RE.match(raw_s):
        ...
        if m:
            ...
            # Troisieme voie (#179 B10) : le mot doit etre une cle de la table
