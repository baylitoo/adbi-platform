    ...
    "resume": {
        ...
        "fields": [
            ...
            {"name": "title", "type": "string",
             "description": "Intitule de poste affiche en tete du CV, pas l'intitule d'une mission particuliere",
             "fields": []},
            {"name": "years_experience", "type": "number",
             "description": "Nombre total d'annees d'experience professionnelle, en chiffres",
             "fields": []},
            {"name": "contact", "type": "object", "description": None, "fields": [
                ...
                {"name": "location", "type": "string",
                 "description": "Ville de residence du candidat, pas le lieu d'une mission",
                 "fields": []},
            ]},
            {"name": "experience", "type": "list", "description": None, "fields": [
                {"name": "company", "type": "string",
                 "description": "Employeur qui salarie ou porte le consultant sur cette mission, pas le client final",
                 "fields": []},
                {"name": "end_client", "type": "string",
                 "description": "Client final chez qui la mission a ete realisee, quand le CV le nomme, distinct de l'employeur",
                 "fields": []},
                {"name": "via", "type": "string",
                 "description": "Societe intermediaire par laquelle la mission a ete realisee, quand le CV en nomme une, distincte du client final et de l'employeur",
                 "fields": []},
                {"name": "title", "type": "string",
                 "description": "Role tenu sur cette mission, pas l'intitule de poste affiche en tete du CV",
                 "fields": []},
                {"name": "start_date", "type": "date",
                 "description": "Date de debut de cette mission",
                 "fields": []},
                {"name": "end_date", "type": "date",
                 "description": "Date de fin de cette mission, vide si la mission est en cours",
                 "fields": []},
                {"name": "location", "type": "string",
                 "description": "Lieu ou cette mission a ete realisee, pas la ville de residence du candidat",
                 "fields": []},
            ...
            {"name": "languages", "type": "list", "description": None, "fields": [
                ...
                {"name": "level", "type": "string",
                 "description": "Niveau declare pour cette langue, recopie tel qu'imprime",
                 "fields": []},
            ]},
