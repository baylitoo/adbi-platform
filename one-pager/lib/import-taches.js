 ...
 *
 * En memoire et borne :
 *   - MAX_SIMULTANEES (2) extractions a la fois : les 2 slots que #194 fixe pour
 *     LFM2.5-2.6B. Au-dela, les requetes attendraient DANS llama-server et cette
 *     attente consommerait le `timeout_seconds` de DocIE ;
